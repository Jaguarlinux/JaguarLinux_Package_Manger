...
DULGE is a binary package system
...
- [Void linux team (main author)](https://github.com/void-linux/dulge)
...
By default the `dulge` package provides only the main Void repository in the `/usr/share/dulge.d/00-repository-main.conf` file.
