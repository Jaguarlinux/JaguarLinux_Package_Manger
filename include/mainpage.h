 ...
 *
 * PS4 is a new binary package system designed and implemented from
 * scratch, by <b>Juan Romero Pardines</b>. This document describes
 * the API used by the PS4 Library, that is the base to implement
 * a package manager frontend, such as is implemented in the ps4
 * command line interfaces.
 *
 * PS4 uses extensively NetBSD's proplib, a library that provides an
