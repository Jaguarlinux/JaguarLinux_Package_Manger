...
# TODO: hack to prevent ps4 trying to validate the downloaded packages
p404 = pmpkg('pkg404')
...
#self.addrule("PS4_RETCODE=0") # TODO
self.addrule("PS4_OUTPUT={}".format(normal_url.replace("http://", "")))
self.addrule("!PS4_OUTPUT={}".format(cache_url.replace("http://", "")))
